                    ...
                    <div class="d-flex">
                        <ol class="breadcrumb m-b-10">
                            ...
                            <li class="breadcrumb-item"><a style="margin-left: 1px;"
                                    href="{{url('/admin/SiteMainStore')}}">المخزن الرئيسى</a></li>
                            <li class="breadcrumb-item active">أضافة مخزن جديد </li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="m-b-0">أضافة مخزن جديد</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{url('/admin/AddMainStore')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('store_name') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="store_name" class="form-control"
                                                placeholder="اسم المخزن الرئيسى" value="{{ old('store_name') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('store_address') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="store_address" class="form-control"
                                                placeholder="عنوان المخزن الرئيسى" value="{{ old('store_address') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('store_admin_name') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" id="firstName" name="store_admin_name"
                                                class="form-control" placeholder="المسئول عن المخزن" value="{{ old('store_admin_name') }}">
