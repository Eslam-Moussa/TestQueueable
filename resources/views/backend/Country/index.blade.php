                ...
                <div class="col-md-7">
                    <div class="d-flex">
                        <ol class="breadcrumb m-b-10">
                            ...
                            <li class="breadcrumb-item active">البلاد</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted">عدد البلاد</p>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="counter text-primary">{{$Countrycount}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    <h3><i class="icon-globe"></i></h3>
                                    <p class="text-muted">عدد البلاد المفعله</p>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="counter text-cyan">{{$Countrycountactive}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    <h3><i class="icon-globe"></i></h3>
                                    <p class="text-muted">عدد البلاد الغير مفعله</p>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="counter text-purple">{{$CountrycountUnactive}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">أضافه بلد جديدة</h4>
                    </div>
                    <div class="modal-body">
                        <form action="{{url('/admin/AddNewCountry')}}" method="post" enctype="multipart/form-data"
                            class="form-material m-t-40">
                            {{ csrf_field() }}
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>اسم البلد بالعربى</label>
                                    <input type="text" name="country_name" class="form-control"
                                        placeholder="اسم البلد بالعربى" required>
                                </div>
                            </div>
        ...
        <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="exampleModal" aria-hidden="true"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{url('/admin/EditNewCountry')}}" method="post" enctype="multipart/form-data"
                            class="form-material m-t-40">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">جدول بعرض جميع البلاد المضافة</h6>
...
<script>
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#country_name').val(country_name);
    })
