                ...
                <div class="col-md-7">
                    <div class="d-flex">
                        <ol class="breadcrumb m-b-10">
                            ...
                            <li class="breadcrumb-item active">أضافة شركة جديدة </li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="m-b-0">أضافة شركة جديدة</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{url('/admin/AddShippingCompany')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('ship_image') ? ' has-danger' : '' }}">
                                            <label class="control-label">صورة الشركة <span
                                                    style="color: red">*</span></label>
                                            <input type="file" id="firstName" name="ship_image" class="dropify">
