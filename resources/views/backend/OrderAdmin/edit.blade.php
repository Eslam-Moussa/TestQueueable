            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">تعديل بيانات الطلب</h4>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Tab panes -->
                        <form action="{{url('/admin/EditOrderInternal/'.$order->id)}}" method="post"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="order_admin_name"
                                                    value="{{$order->order_admin_name}}" class="form-control"
                                            ...
                                            <div
                                                ...
                                                <select class="select2 form-control custom-select"
                                                    ...
                                                    <option value="{{$user->id}}" @if($user->id ==
                                                        $order->order_user_id)selected @endif>{{$user->name}}
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control custom-select"
                                                    style="width: 100%; height:36px;" name="stored_id[]" disabled>
                                                    <option value="">اختر</option>
                                                    @if(!empty($stores))
                                                    @foreach($stores as $stor)
                                                    <option value="{{$stor->id}}" @if($stor->id ==
                                                        $detail->stored_id)selected @endif>{{$stor->store_name}}
                                                    </option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control custom-select"
                                                    style="width: 100%; height:36px;" name="prodect_id[]" disabled>
                                                    <option value="">اختر</option>
                                                    @if(!empty($product))
                                                    @foreach($product as $pro)
                                                    <option value="{{$pro->id}}" @if($pro->id ==
                                                        $detail->prodect_id)selected @endif>{{$pro->product_name}}
                                                    </option>
                                                    @endforeach
                                                    @endif
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="product_parcode[]"
                                                        value="{{$detail->product_parcode}}" class="form-control"
                                                        placeholder="الباركود" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">اللون</label>
                                                <select class="form-control custom-select"
                                                    style="width: 100%; height:36px;" name="color_id[]" disabled>
                                                    <option value="">اختر</option>
                                                    @if(!empty($StoreColor))
                                                    @foreach($StoreColor as $color)
                                                    <option value="{{$color->col_id}}" @if($color->col_id ==
                                                        $detail->color_id)selected @endif>{{$color->color_name}}
                                                    </option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control custom-select"
                                                    style="width: 100%; height:36px;" name="style_id[]" disabled>
                                                    <option value="">اختر</option>
                                                    @if(!empty($StoreStyle))
                                                    @foreach($StoreStyle as $style)
                                                    <option value="{{$style->col_id}}" @if($style->col_id ==
                                                        $detail->style_id)selected @endif>{{$style->settingstyle_desc}}
                                                    </option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control custom-select"
                                                    style="width: 100%; height:36px;" name="size_id[]" disabled>
                                                    <option value="">اختر</option>
                                                    @if(!empty($StoreSize))
                                                    @foreach($StoreSize as $size)
                                                    <option value="{{$size->sit_id}}" @if($size->sit_id ==
                                                        $detail->size_id)selected @endif>{{$size->size_value}}</option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="number_size[]" value="{{$detail->number_size}}" class="form-control"
                                                        placeholder="العدد المتاح" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">العدد المطلوب</label>
                                                    <input type="text" name="pro_count[]" id="count"
                                                        class="form-control" value="{{$detail->pro_count}}" placeholder="العدد" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pro_price[]" id="price"
                                                        class="form-control" value="{{$detail->pro_price}}" placeholder="السعر" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pro_price_total[]" id="result"
                                                        class="form-control" value="{{$detail->pro_price_total}}" placeholder="اجمالى السعر" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            </div>
