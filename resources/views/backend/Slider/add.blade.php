                ...
                <div class="col-md-7">
                    <div class="d-flex">
                        <ol class="breadcrumb m-b-10">
                            ...
                            <li class="breadcrumb-item active">اضافة صورة جديدة</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="m-b-0">اضافة صورة جديدة</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" name="slider_desc"
                                                maxlength="100"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('slider_image') ? ' has-danger' : '' }}">
                                            <label class="control-label">الصورة<span style="color: red">*</span></label>
                                            <input type="file" id="input-file-now" name="slider_image"
                                                class="dropify" />
                                            @if ($errors->has('slider_image'))
                                            <small class="form-control-feedback">{{ $errors->first('slider_image') }}
                                            </small>
                                            @endif
                                        </div>
                                    </div>
