    ...
    <div class="container-fluid">
                ...
                <div class="col-md-7">
                    <div class="d-flex">
                        <ol class="breadcrumb m-b-10">
                            ...
                            <li class="breadcrumb-item active">الألوان</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">أضافه لون جديد</h4>
                    </div>
                    <div class="modal-body">
                        <form action="{{url('/admin/AddSettingColor')}}" method="post" enctype="multipart/form-data"
                            class="form-horizontal m-t-40">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="control-label">اللون<span
        ...
        <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="exampleModal" aria-hidden="true"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">تعديل بيانات اللون</h4>

                    </div>
                    <div class="modal-body">
                        <form action="{{url('/admin/EditSettingColor')}}" method="post" enctype="multipart/form-data"
                            class="form-horizontal m-t-40">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">الألوان</h4>
                    <h6 class="card-subtitle">جدول بعرض جميع الألوان المضافة</h6>
...
<script>
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#color_name').val(color_name);
    })
